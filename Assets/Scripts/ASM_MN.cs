...
public class ASM_MN : Singleton<ASM_MN>
{
    ...
    public void YC1()
    {
        ...
        Players player1 = new Players(id, "Dat", 50, new Region(2, "VN2"));
        listPlayer.Add(player1);
        Players player2 = new Players(id, "Duy", 100000, new Region(3, "JS"));
        listPlayer.Add(player2);
        Players player4 = new Players(id, "Tiu", 500, new Region(4, "VN"));
        listPlayer.Add(player4);
        Players player5 = new Players(id, "Anh", 700, new Region(5, "VS"));
